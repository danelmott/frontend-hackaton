...
export default function Sidebar({ isOpen, setIsOpen }) {
  ...
  const showChatLoading = authLoading || Boolean(user && isLoadingChats);
        ...
        <div className={styles.sidebarInner}>
          ...
          <nav className={styles.chatList}>
            {showChatLoading ? (
              ...
              <p className={`${styles.sectionLabel} ${styles.chatListEnter}`}>
                No tienes chats aún
              </p>
            ) : chats.length > 0 ? (
              <div className={`${styles.section} ${styles.chatListEnter}`}>
